...
namespace jsond {
    ...
    namespace internal {
        ...
        static ::jsond::internal::RecursiveTypelist<type, decltype(__list_maker_helper(::jsond::internal::Counter<__COUNTER__>{}))> \
        __list_maker_helper(::jsond::internal::Counter<__COUNTER__>)
        
        #define _END_LIST() \
        typedef \
        jsond::internal::FlattenRecursiveTypelist<decltype(__list_maker_helper(::jsond::internal::Counter<__COUNTER__>{}))>::value \
        __member_typelist;
    } // namespace internal
    ...
    namespace impl {
        ...
        template <typename T, int ID> std::string JSONDecodableMemberBase<T, ID>::member_name;
        template <typename T, int ID> T* JSONDecodableMemberBase<T, ID>::member_ptr;
        ...
        */
        ...
        template <typename T, int ID> struct JSONDecodableArrayValueObject : JSONDecodableArrayValueBase<T, ID> {};
        template <typename T, int ID> struct JSONDecodableArrayValuePrimitive : JSONDecodableArrayValueBase<T, ID> {};
        template <typename T, typename V, int ID>
        ...
        /*
         ...
         Used to automatically deduce what the inner type representation for a member type should be.
        */
        ...
        struct __deduce_impl_type<C<T, Args...>, ID, false> {
            typedef ::jsond::impl::JSONDecodableMemberArray<C<T, Args...>,
                typename ::jsond::impl::__deduce_impl_type<T, ID, true>::type, ID> type;
        };
        ...
        // XXX: std::string would be treated as an array so we explicitly specialize it as a primitive
        template <int ID>
        ...
        */
        ...
        struct __decode_member<::jsond::impl::JSONDecodableMemberPrimitive<T, ID>> {
            static void decode(const rapidjson::Value::Object& obj) {
                ...
                assert(it != obj.end());
                *member_t::member_ptr =
                    ::jsond::impl::__primitive_value_decoder<typename member_t::member_type>::get(it->value);
            }
        };
     ...
     */
    #define BEGIN_MEMBER_DECLARATIONS() \
    _START_LIST()
    ...
    #define END_MEMBER_DECLARATIONS() \
    _END_LIST()
